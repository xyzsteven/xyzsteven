    ...
    <header className={styles.blogHeader}>
      <div className={styles.headerContent}>
        <div className={styles.issueLabel}>
          <span className={styles.terminalUser}>blog@xyzsteven:~$</span>
          <span className={styles.terminalCursor} />
        </div>
        <h1 className={styles.blogTitle}>
          Thoughts on
          <br />
          <span className={styles.titleAccent}>Exploration</span>
        </h1>
        <p className={styles.blogSubtitle}>
          Notes, ideas, and small personal write-ups.
        </p>
        <div className={styles.headerMeta}>
          <span className={styles.postCount}>1 articles</span>
          <span className={styles.divider}>·</span>
          <span className={styles.latestLabel}>Latest: January 2026</span>
        </div>
      </div>
    </header>
  );
...
export default function BlogListPage(props: Props): JSX.Element {
  return (
    <Layout title="Blog" description="Notes, ideas, and small personal write-ups.">
