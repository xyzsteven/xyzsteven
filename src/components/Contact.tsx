...
const contactLinks = [
  ...
  {
    label: 'Email',
    href: 'mailto:julianosteven@gmail.com',
    icon: (
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            Feel free to reach out if you have a question or just want to chat about 
            Security, Pentesting, System or Android Customization. I'm glad to share and learn new things.
          </p>
