      ...
      <div className={styles.heroContent}>
        <div className={styles.heroMain}>
          <div className={styles.heroLabel}>
            <span className={styles.terminalUser}>self@xyzsteven:~$</span>
          ...
          <div className={styles.heroActions}>
            <Link to="https://github.com/xyzsteven" className={styles.secondaryButton}>
            ...
            <Link to="https://linkedin.com/in/stevenjuliano" className={styles.secondaryButton}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
export default function Home(): JSX.Element {
  return (
    <Layout title="Home" description="Portfolio of Steven Juliano - Cybersecurity Engineering Student at Polibatam">
      <HomepageHero />
